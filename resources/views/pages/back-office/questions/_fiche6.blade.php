...
<fieldset class="pre-scrollable"> 
  <h2 class='fs-title'>INFORMATIONS D’ORDRE SPECIFIQUE</h2>
 

  <div class='row'>
  @csrf

  @foreach ($q_fiche6 as $question)
  <br/>
...
<button type="submit" class="btn btn-primary btn-lg">Enregistrer et Renseigner la Fiche 3</button>
