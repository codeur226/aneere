                ...
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="card">
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title">Listes des cabinets</h3>
                                        <div class="ml-auto pageheader-btn">
                                            <a href="{{ route('auditeurs.create',['statut' => $cabinet]) }}" class="btn btn-primary btn-icon text-white">
                                                <span>
