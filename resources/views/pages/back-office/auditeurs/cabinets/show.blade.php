...
<li class="breadcrumb-item"><a href="{{ route('auditeurs.index',['statut'=>'cabinet']) }}">Auditeurs agréés</a></li>
                                      ...
                                      <div class="row">
                                          <div class="col-lg-6">
                                            <dl class="dl">
                                                ...
                                                <dt> Numéro RCCM : </dt>
                                                <dd> {{ $auditeur->num_rccm == null ? "(Non défini)": $auditeur->num_rccm }}   </dd>
                                                <dt> Numéro IFU : </dt>
                                                <dd>   {{ $auditeur->num_ifu == null ? "(Non défini)": $auditeur->num_ifu}}     </dd>
                                                <dt>Date de creation :</dt>
                                                <dd> {{ formatdate($auditeur->date_creation) }} </dd>
