                ...
                <div class="card-body">
                        ...
                        <div class="form-group input-group">
                            <span class="has-float-label">
                              <input type="text" class="form-control" name="nom" value="{{ old('nom_auditeur') ?? $auditeur->nom }}" id="nom_auditeur" placeholder="Nom et Prénom" required/>
                              <label for="nom_auditeur">Nom et Prénom</label>
                            </span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="wd-200 mg-b-30">
                    ...
                    <div class="form-group input-group">
                        <span class="has-float-label">
                        <input type="text" class="form-control" name="tel_fixe" id="tel_fixe" value="{{ old('tel_fixe') ?? $auditeur->tel_fixe}}"   placeholder="N° de télephone fixe"  />
