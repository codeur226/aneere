        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="wd-200 mg-b-30">
                    <div class="form-group input-group">
                        <span class="has-float-label">
                          <input type="number" class="form-control" name="secteur" id="secteur" value="{{ old('secteur') ?? $auditeur->secteur}}"  placeholder="secteur"  required/>
                    ...
                    <div class="form-group input-group">
                        <span class="has-float-label">
                          <input type="number" class="form-control" name="rue" id="rue" value="{{ old('rue') ?? $auditeur->rue}}"  placeholder="rue"  required/>
                    ...
                    <div class="form-group input-group">
                        <span class="has-float-label">
                          <input type="number" class="form-control" name="num_porte" id="num_porte" value="{{ old('num_porte') ?? $auditeur->num_porte}}"  placeholder="num_porte"  required/>
                    ...
                    <div class="form-group input-group">
                        <span class="has-float-label">
                        <input type="text" class="form-control" name="num_bp" id="num_bp" value="{{ old('num_bp') ?? $auditeur->num_bp}}" placeholder="Boite postale"  required/>
