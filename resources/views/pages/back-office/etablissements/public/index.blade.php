                ...
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="card">
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title">Listes des établissements publics</h3>
                                        <div class="ml-auto pageheader-btn">
                                            <a href="{{ route('consommateurs.create',['statut'=>'public']) }}" class="btn btn-primary btn-icon text-white">
                                                <span>
                                   ...
                                   @if($etablissements->count() > 0)
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <div class="card-body">
                                                <div class="padding-6">
                                                    Aucun etablissement n'est disponible pour le moment !!!!
                                                </div>
                                            </div>
