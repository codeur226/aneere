    ...
    <div class="row" id="user">
        <div class="col-lg-6">
            <div class="card">
                        ...
                        <div class="row px-2">
                            <div >
                                <div class="custom-controls-stacked">
                                    <label for="publique">
                                        <input type="radio" id="publique" name="statut" value="publique" {{ old('statut', $etablissement->statut)== "publique" ? 'checked' : '' }}  onclick="ShowHideDiv()" required/>
                                        <span class="">Etablissement publique</span>
                                    </label>
                                </div>
                            </div>
                            <div class="ml-auto">
                                <div class="custom-controls-stacked">
                                    <label for="prive">
                                        <input type="radio" id="prive" value="privé" {{ old('statut', $etablissement->statut)== "privé" ? 'checked' : '' }}  name="statut" onclick="ShowHideDiv()" required/>

                                        <span class="">Etablissement privée</span>
                ...
                {{-- <div class="form-group input-group" id="num_rccm" @if((Route::current()->getName() =='etablissements.edit') && ($etablissement->statut == 'privé') ) style="display:flex" @else style="display:none" @endif>
                    <span class="has-float-label">
                ...
                <div class="form-group input-group" id="num_ifu" @if((Route::current()->getName() =='etablissements.edit') && ($etablissement->statut == 'privé') ) style="display:flex" @else style="display:none" @endif>
                    <span class="has-float-label">
                ...
                <div class="form-group input-group" id="autre" @if((Route::current()->getName() =='etablissements.edit') && ($etablissement->statut == 'privé') ) style="display:flex" @else style="display:none" @endif>
                    <span class="has-float-label">
                ...
                {{-- <div class="form-group input-group">
                    ...
                    <select class="form-control" name="secteur" id="secteur" required>
                        ...
                        <option value="Industrie" @if($etablissement->secteur == "Industrie") selected @endif>Industrie  </option>
                        <option value="Transport" @if($etablissement->secteur == "Transport") selected @endif>Transport  </option>
                        <option value="Bâtiment" @if($etablissement->secteur == "Bâtiment") selected @endif>Bâtiment  </option>
                    </select>
                    <label for="nom_etassement">Secteur blid'activité</label>
                    </span>
