          ...
          <div   class="container ">
              <div class="row bg-white">
                  <div class="list-group list-group-flush col-3 mt-5">
                      ...
                      <a href="{{ route('reglementations.search',$type) }}" class="list-group-item @if($type->id == $type_id) {{ set_active_green(['reglementations.search']) }}@endif list-group-item-action">{{  $type->libelle}} ({{ $type->reglementations->count() }}) </a>
                      @php ($total +=$type->reglementations->count() )
                      @endforeach
                      <a href="{{ route('reglementations.search',-1) }}" class="list-group-item list-group-item-action @if($type_id == -1) {{ set_active_green(['reglementations.search']) }}@endif"> TOUTE TYPE ({{ $total }}) </a>
                  </div>
                  ...
                  <div class="col-9">
                      ...
                      <table id="secteur" class="table shopping-summery" >
                          ...
                          <tbody>
                              ...
                              <tr class="line" style="text" data-href="{{ asset('storage/'.$reglementation->fichier) }}"  style="font-size: 13px;">
                                  <td>
